  ...
  function setupCli(cli) {
    ...
    cli
      .command('index [config]')
        .description('Index the given spec file and load the data into Elasticsearch. Config is optional, defaults to ' + rootDir + '/config.js')
    ...
    cli
      .command('clear [config]')
        .description('Clears the index for the given spec file from Elasticsearch. Config is optional, defaults to ' + rootDir + '/config.js')
